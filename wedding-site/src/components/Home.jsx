     ...
     <img src={P10} className="photo" id="auburnhair"/>
        ...
        <div className="home-text">
            <h3> After a few weeks of chatting through the dating app Bumble, we had our first date in May of 2018, where we 
                ...
                After a few seasons of travelling between Queens and Long Beach, a disaster at Jeremy's apartment brought the two closertogether in the Spring of 2018, moving into their first apartment together(but if Michael or Anne Marie ask, the two still sleep in seperate rooms). On November 7, 2020,
                ...
                Jeremy proposed to Alyssa. And for reasons he still can not fully understand, she said Yes. 
                <br/>
